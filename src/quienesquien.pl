...
% Predicado para consultar características de los personajes

tiene_caracteristica(Nombre , Caracteristica) :-
    personaje(Nombre / Caracteristicas),
    member(Caracteristica, Caracteristicas).

% Predicado para obtener todas las características de un personaje

obtener_caracteristicas(Personaje, Caracteristicas) :-
    personaje(Personaje / Caracteristicas).

% Predicado para obtener la lista de personajes

obtener_nombres(Nombres) :-
    findall(Nombre, (personaje(Nombre / _)), Nombres).

% Predicado para recopilar características únicas

caracteristicas_unicas(CaracteristicasUnicas) :-
    findall(Caracteristicas, personaje(_ / Caracteristicas), ListaCaracteristicas),
    flatten(ListaCaracteristicas, CaracteristicasPlanas),
    sort(CaracteristicasPlanas, CaracteristicasUnicas).
